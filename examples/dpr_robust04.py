...
def dense_passage_retrieval():
    ...
    data_dir = "data/"
    train_filename = "robust04_train.json"
    dev_filename = "robust04_dev.json"
    test_filename = "robust04_dev.json"
    ...
    # for param in question_language_model.model.question_encoder.bert_model.parameters():
    #     param.requires_grad = False
    # for param in passage_language_model.model.ctx_encoder.bert_model.parameters():
   #    param.requires_grad = False
